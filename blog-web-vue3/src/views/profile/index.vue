  ...
  <div class="profile-container">
    ...
    <main class="content-area" role="main">
      ...
      <div v-if="currentTab === 'moments'" class="content-section">
        ...
        <div v-custom-loading="loading" v-if="moments.length">
      ...
      <div v-if="currentTab === 'posts'" class="content-section">
        ...
        <div v-custom-loading="loading" v-if="posts.length">
      ...
      <div v-if="currentTab === 'comments'" class="content-section">
        ...
        <div v-if="myComments.length" v-custom-loading="loading">
      ...
      <div v-if="currentTab === 'replies'" class="content-section">
        ...
        <div v-if="myReplies.length" v-custom-loading="loading">
      ...
      <div v-if="currentTab === 'likes'" class="content-section">
        ...
        <div v-if="myLikes.length" v-custom-loading="loading">
        ...
        <el-tabs>
          ...
          <el-tab-pane label="我的反馈">
            <div class="feedback-list">
              <div v-custom-loading="loading" v-if="myFeedbacks.length">
